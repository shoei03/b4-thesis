...
method_lineage_labeled = pd.read_csv(
    "./output/versions/method_lineage_labeled.csv",
    usecols=["revision", "global_block_id", "file_path"],
)
ground_truth = pd.read_csv(
    "./output/versions/method_lineage/ground_truth.csv",
    usecols=["global_block_id", "revision", "state_with_clone"],
)
deleted_file_path = pd.read_csv(
    "./output/versions/method_lineage/deleted_files.csv", usecols=["File Name"]
)
...
df["file_deleted"] = (df["state_with_clone"] == "all_deleted") & (
    df["file_path"].isin(deleted_files_set)
)
